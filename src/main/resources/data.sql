...
--        ('user1', '2024-01-21', NULL, NULL, 'thu duc', '2024-01-22', 'longan@gmail.com', 'nguyen long an ', 'nam ', NULL,
--         true, '123', '0912213212', true),
--        ('user2', '2024-01-21', NULL, NULL, 'binh duong', '2024-01-21', 'hieu@gmail.com', 'nguyen minh hieu', 'nam ',
--         NULL, true, '123', '0123244555', true),
--        ('user3', '2024-01-20', NULL, NULL, 'dong nai', '2024-01-20', 'thangla@gmail.com', 'nguyen minh thang ', 'nam',
--         NULL, true, '123', '0213123923', true),
--        ('user4', '2024-01-18', NULL, NULL, 'vung tau', '2024-01-18', 'kienq7@gmail.com', 'nguyen trung kien ', 'nam ',
--         NULL, true, '123', '0912353451', true),
--        ('user5', '2024-01-18', NULL, NULL, 'lam dong ', '2024-01-18', 'nam@gmail.com', 'tran pham thanh nam ', 'nam',
--         NULL, true, '123', '0873232338', true),
--        ('user6', '2024-01-17', NULL, NULL, 'vinh long', '2024-01-17', 'phat@gmail.com', 'nguyen tien phat', 'nam', NULL,
--         true, '123', '0923881391', true),
--        ('user7', '2024-01-10', NULL, NULL, 'long tam ', '2024-01-10', 'tam@gmail.com', 'nguyen minh tam', 'nam', NULL, true,
--         '123', '0231893131', true),
--        ('user8', '2024-01-9', NULL, NULL, 'long phuoc', '2024-01-9', 'phuoc@gmail.com', 'phan tan phuoc', 'nam', NULL,
--         true, '123', '0412939121', true),
--        ('user9', '2024-01-2', NULL, NULL, 'phu my', '2024-01-5', 'my@gmail.com', 'nguyen thi kim my', 'nu', NULL, false,
--         '123', '0912325341', false),
--        ('user10', '2024-01-1', NULL, NULL, 'tan binh', '2024-01-1', 'binh@gmail.com', 'kim binh mai', 'nu', NULL, true,
--         '123', '0934234234', true);
--
